...
#train_x, label, miss_column, algorithm, file_name, label_field=0
...
def single_benchmark(train_x, label, miss_column, file_name, label_field, algorithm_list=ALGORITHMS, task_id=1):
    ...
    #scores = [frac_missing_prop, frac_features, mt_mean_impute[0], mt_reduced[0], mt_mice_impute[0], algorithm, file_name]
